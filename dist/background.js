...
chrome.contextMenus.onClicked.addListener(/*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(info, tab) {
    var selectedText, mode, rewrittenText;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log("Menu item clicked: ".concat(info.menuItemId, "\nSelected text: ").concat(info.selectionText));
          selectedText = info.selectionText;
          mode = '';
          _context.t0 = info.menuItemId;
          _context.next = _context.t0 === "rewrite-professional" ? 6 : _context.t0 === "rewrite-casual" ? 8 : _context.t0 === "rewrite-formal" ? 10 : _context.t0 === "rewrite-informal" ? 12 : 14;
          break;
        case 6:
          mode = "Professional";
        ...
        case 16:
          _context.prev = 16;
          _context.next = 19;
          return rewrite(selectedText, mode);
        case 19:
          rewrittenText = _context.sent;
          console.log("Rewritten text: ".concat(rewrittenText));

          // Send a message to the content script to show the pop-up with the rewritten text
        ...
        case 24:
          ...
          console.error("Error rewriting text:", _context.t1);
        case 27:
        case "end":
...
function rewrite(_x3, _x4) {
  return _rewrite.apply(this, arguments);
}
function _rewrite() {
  _rewrite = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(text, mode) {
    var groq, _response$choices$, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          groq = new groq_sdk__WEBPACK_IMPORTED_MODULE_0__["default"]({
            apiKey: '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'
          ...
          return groq.chat.completions.create({
            messages: [{
              role: "user",
              content: "Rewrite the following text in ".concat(mode, ": ").concat(text, ". Provide only the rewritten text without any additional information.")
            }],
            model: "llama3-8b-8192"
          });
        case 4:
          response = _context2.sent;
          return _context2.abrupt("return", ((_response$choices$ = response.choices[0]) === null || _response$choices$ === void 0 || (_response$choices$ = _response$choices$.message) === null || _response$choices$ === void 0 ? void 0 : _response$choices$.content) || "");
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](1);
          console.error("Error in Groq API call:", _context2.t0);
          throw _context2.t0;
        case 12:
        case "end":
